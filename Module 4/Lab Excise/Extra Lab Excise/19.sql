...
-- );
-- insert all
--     into books(book_id,title,author,publisher,year_of_publication,price) values (101,'The White Tiger','Harper Adiga','Harporcollin India',2008,299)
-- 	into books(book_id,title,author,publisher,year_of_publication,price) values (102,'George Orwell','Harper Adiga','Secker & Warburg',1984,99)
-- 	into books(book_id,title,author,publisher,year_of_publication,price) values (103,'Kabir Ke Dohe',null,'Sahitya Akadami',1500,59)
-- 	into books(book_id,title,author,publisher,year_of_publication,price) values (104,'Madhudhala','Harivansh Rai Bachhan','Prabhat Prakashan',1935,89)
-- 	into books(book_id,title,author,publisher,year_of_publication,price) values (105,'The God Of Samll Things',null,'Doubley',1950,190)
-- select * from dual;
-- select * from books;
declare 
