"""
Django settings for EMAIL_SEMS_ROZERPAY project.
...
SECRET_KEY = 'django-insecure-xgfu!+fqt94y-m#j#q-q@a$%ge&!kk0*j5qonpd02^3-9opy!l'
...
ROOT_URLCONF = 'EMAIL_SEMS_ROZERPAY.urls'
...
WSGI_APPLICATION = 'EMAIL_SEMS_ROZERPAY.wsgi.application'
