...
function MiniProfile(props) {
    return (
        ...
        <div className="max-w-lg w-full bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200 mx-55">
            {/* Header */}
            <div className="flex items-start justify-between mb-3">
                <div className="flex items-center space-x-3">
                    <a href="" target="_blank" rel="noopener noreferrer" className="flex-shrink-0">
                        <img src={user} alt="" className="w-12 h-12 rounded-full object-cover border border-gray-200" />
                    </a>
            ...
            <div className="mb-3">
                <div className="rounded-xl overflow-hidden border border-gray-200">
                    <img src={postimage} alt="" className="w-full h-64 object-cover"
                    />
                </div>
            </div>
        </div>
